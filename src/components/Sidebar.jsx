...
const Sidebar = () => {
  ...
  const allNavItems = [
    ...
    { icon: <BookOpen size={20} />, label: 'Classes', path: '/academics/classes', roles: ['admin', 'teacher'] },
    { icon: <Book size={20} />, label: 'Subjects', path: '/academics/subjects', roles: ['admin', 'teacher'] },
